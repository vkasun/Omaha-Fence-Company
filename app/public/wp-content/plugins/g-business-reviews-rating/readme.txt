...
Tags: google reviews, reviews, google my business, google rating, google places, structured data, gmb reviews, gmb rating
...
Do you have a *Google My Business* listing and would like to show your current customer reviews and rating on your website? 

This plugin will collect this data using your unique Google Place ID and display a well-formatted list or column/blocks of reviews, and some associated links to reviews and Google map listing, plus point customers to post their review and rating on Google. Don’t worry: there are no restrictions to the reviews collection and plenty of options to display it perfectly on your website.
...
Individually, this plugin will only use a fraction of your free allowance. However, for piece of mind you can limit the request to ensure it stays within your free allowance. Go to [Google Maps Platform: Quotas](https://console.cloud.google.com/google/maps-apis/quotas); select Places API from the dropdown at the top; in the first Requests section, set the “Requests per day” to 100 and click Save.
...
If you’re either a vague error message or no error message at all, please try enabling: Clean Retrieved Data in the Setup tab and then Clear Cache in the Advanced tab.
...
* Added new parameters to override the URLs of read reviews and write a review
