...
?>
        ...
        <p class="limit">
			...
			<span class="description"><a href="<?php echo esc_attr($this->plugin_settings_url . '#reviews'); ?>"><?php ($count == 1) ? printf(__( '%1$s review available'), $count) : printf(__( '%1$s reviews available'), $count); ?></a></span>
        </p>
        <p class="view">
...
?>
        ...
        <p class="buttons"><a href="<?php echo esc_attr($this->plugin_settings_url); ?>" class="button button-secondary"><?php esc_html_e('Settings', 'g-business-reviews-rating'); ?></a><?php echo ($this->demo) ? ' <a href="' . esc_attr($this->plugin_settings_url) . '" class="demo"><span class="dashicons dashicons-warning"></span> ' . __('Demo Mode', 'g-business-reviews-rating') . '</a>' : ''; ?></p>
    </div>
